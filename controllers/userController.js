...
exports.resizeUserPhoto = AsyncHandle(async (req, res, next) => {
...
exports.updateProfile = AsyncHandle(async (req, res, next) => {
  if (req.body.password || req.body.passwordConfirm)
    return next(
      new ErrorHandle('This route is not for password updates.', 400)
    );
...
exports.inactiveAccount = AsyncHandle(async (req, res, next) => {
