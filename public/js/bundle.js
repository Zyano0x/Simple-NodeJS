  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'http://127.0.0.1:1337/api/v1/users/update_password' : 'http://127.0.0.1:1337/api/v1/users/update_profile';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var deletePhoto = exports.deletePhoto = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'DELETE',
            url: "http://127.0.0.1:1337/api/v1/photos/".concat(id)
          });
        case 3:
          res = _context.sent;
          if (res.status === 204) {
            (0, _alerts.showAlert)('success', 'Delete successfully!');
            window.setTimeout(function () {
              location.assign('/');
            }), 1500;
          }
  ...
  return function deletePhoto(_x) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"download.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.downloadPhotos = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var downloadPhotos = exports.downloadPhotos = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(url, filename) {
    var response, link, a;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          ...
          link = window.URL.createObjectURL(new Blob([response.data]));
        ...
        case 14:
          _context.prev = 14;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('error', 'Error downloading image');
        case 17:
        case "end":
          return _context.stop();
      }
  ...
  return function downloadPhotos(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"likes.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var like = exports.like = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.status === 201) {
            (0, _alerts.showAlert)('success', 'You liked this photo');
            location.reload(true);
          }
          _context.next = 10;
          break;
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"overview.js":[function(require,module,exports) {
"use strict";
...
function submitForm(event) {
  ...
  window.location.href = "http://127.0.0.1:1337/search/".concat(searchInput.replace('#', '?hashtags=').replaceAll('#', ','));
}
...
var signUpForm = document.querySelector('.form--register');
var logOutBtn = document.querySelector('.nav__el--logout');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var deleteBtn = document.querySelectorAll('.btn--delete');
var downloadBtn = document.getElementById('download-all');
var likeIcon = document.getElementById('heart');
var searchForm = document.querySelector('.box-search');
...
if (downloadBtn) downloadBtn.addEventListener('click', function (e) {
  ...
  arr.forEach(function (img) {
    (0, _download.downloadPhotos)("/img/photos/".concat(img), img);
  });
  setTimeout(function () {
    e.target.textContent = 'Download';
  }, 1500);
});
if (likeIcon) likeIcon.addEventListener('click', function (e) {
  var photo = e.target.dataset.photoId;
...
},{"./login":"login.js","./register":"register.js","./updateSettings":"updateSettings.js","./delete":"delete.js","./download":"download.js","./likes":"likes.js","./overview":"overview.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "53620" + '/');
